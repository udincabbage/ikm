...
$responden = isset($_GET['respon']) ? $_GET['respon'] : ''; 

$pageSql = "SELECT $tableName.id_jawaban,$tableName.id_responden,$tableName.tahun,$tableName.bulan,$tableName.id_kuis,$tableName.jawaban,tkuis.id_aspek,nama_aspek  FROM ".$tableName." LEFT JOIN tkuis ON tkuis.id_kuis=$tableName.id_kuis LEFT JOIN taspek ON taspek.id_aspek=tkuis.id_aspek WHERE $tableName.id_responden='$responden'";
$pageSql2 = "SELECT sum(nilai)/ COUNT(id_kuis) AS total FROM tjawaban_temp WHERE id_responden='".$responden."' ";
...
<table width="100%" class="table table-bordered table-striped">
  <tr>
    <th width="910"><h1><b>Jawaban Kuesioner Responden <?php echo $responden; ?></b>  </h1></th>
