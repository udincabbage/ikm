...
?>
	<form class="form-horizontal"  method="GET" action="page/laporan/jawabancustom-pdf.php?tahun=['tahun']&bulan=['bulan']&aspek=['aspek']" target="_blank">
		<fieldset>
<table class="table table-bordered table-striped">
							<tr>
      <th colspan="2" ><h2>Pilih Detail Laporan Jawaban Kuesioner </h2></th>
    </tr>
<tr>
<td>Tahun</td>
