...
$pageSql = "SELECT $tableName.* FROM ".$tableName." WHERE tahun='".$tahun."' AND bulan='$bulan' ";
$pageSql2 = "SELECT sum(nilai)/ COUNT(id_kuis) AS total FROM tjawaban_temp WHERE tahun='$tahun' AND bulan='$bulan'";
