...
?>
	<form class="form-horizontal"  method="GET" action="page/laporan/kuesioner_user-pdf.php?tahun=['tahun']" target="_blank">
		<fieldset>
<table class="table table-bordered table-striped">
							<tr>
      <th colspan="2" ><h2>Pilih Laporan Hasil Kuesioner</h2></th>
    </tr>
<tr>
<td>Tahun</td>
