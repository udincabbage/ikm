<?php
//harus pakai mysql bahari 
include_once "lib/connection_bahari.php";
$database = 'nkit_ikm_new';
//membuat nama file
$file	  =	'backup/'.$database.'_'.date("DdMY").'_'.time().'.sql';
...
<form action="" method="post" name="postform" enctype="multipart/form-data" >
	<p class="asd">
		<em>Aplikasi ini digunakan untuk <strong>backup</strong> dan <strong>restore</strong> semua data yang ada didalam database  </em>
	</p>
	<div class="asd">
		<label for="backup">Backup database</label><br/>
	...
	<div class="asd">
		...
		<input type="file" name="datafile" size="30" id="gambar" /> <br/>
