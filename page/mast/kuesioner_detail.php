...
// }
$pageQry = mysqli_query($koneksidb, $pageSql) or die ("error paging d : ".mysql_error());
...
<table class="table table-bordered table-striped">
  <tr>
    <th><h3><b>Laporan Kuesioner <?php echo tampil_bulan($totData['bulan']); ?> <?php echo $totData['tahun']; ?></b>   
	<form class="navbar-search pull-right"  method="POST" action="?page=<?php echo $formName?>-Data">
	<a href="page/laporan/kuesioner_detail-pdf.php?Kode=<?php echo $Kode; ?>&Tahun=<?php echo $tahun; ?>&Bulan=<?php echo $bulan; ?>" target="_blank"><img src="img/btn_print.png" width="40px"> </a>
  </form>
	</h3></th>
