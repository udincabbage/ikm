  ...
  <tr>
	...
	<table class="table table-bordered table-striped">
      <tr>
        ...
        <th width="70"><strong><?php echo $isian2; ?></strong></th>
        <th width="120"><strong><?php echo $isian1; ?></strong></th>
		<th width="140"><strong><?php echo $isian3; ?></strong></th>
		<th width="530"><strong><?php echo $isian4; ?></strong></th>
      ...
      <tr>
        ...
        <td> <?php echo indonesiaTgl($kolomData[$field2]); ?> </td>
        <td> <?php echo $kolomData[$field1]; ?> </td>
        <td> <?php echo $kolomData[$field3]; ?> </td>
        <td> <?php echo $kolomData[$field4]; ?> </td>
		<td> <?php echo $id5; ?></td>  
		
       <td class="cc" align="center"><a href="?page=<?php echo $formName;?>-Terima&Kode=<?php echo $Kode; ?>" target="_self"><i class="icon-ok"></i></a></td>
       <td class="cc" align="center"><a href="?page=<?php echo $formName;?>-Tolak&Kode=<?php echo $Kode; ?>" target="_self"><i class="icon-remove"></i></a></td>
