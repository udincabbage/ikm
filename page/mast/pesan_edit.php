...
if($_GET) {
	if(isset($_POST['btnSave'])){
		...
		if (count($pesanError)>=1 ){
			...
			$mySql	= "UPDATE ".$tableName." SET ".$field1."='$txt1', ".$field2."='$txt2', ".$field3."='$txt3'  WHERE ".$field0." ='".$_POST['txt0']."'";
...
<fieldset>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input name="txt1" type="text" class="input-xlarge" value="<?php echo $data1; ?>" size="60" maxlength="60" onkeyup="validHuruf(this)" pattern="[A-Z a-z]{3,56}"  />
								</div>
							</div>
					...
					<div class="control-group">
								...
								<div class="controls">
									<textarea class="input-xlarge" name="txt2" id="txt2" rows="5"><?php echo $data2; ?></textarea>
								</div>
							</div>
