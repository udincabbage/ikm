...
if($_GET) {
	if(isset($_POST['btnSave'])){
		...
		if (count($pesanError)>=1 ){
			...
			$mySql	= "INSERT INTO ".$tableName." (".$field1.",".$field2.",".$field3.",".$field4.",".$field5.",".$field6.",".$field7.") VALUES ('$txt1','$txt2','$txt3','$txt4','$txt5','$txt6','$txt7')";
...
?>
  ...
  <form id="new-project" class="form-horizontal" action="?page=<?php echo $formName;?>-Add" method="post" name="form1" target="_self">
    ...
    <tr>
      ...
      <td width="2%"><b>:</b></td>
      <td width="74%"><input name="txt1" type="text" value="<?php echo $data1; ?>" size="60" onkeyup="validHuruf(this)" pattern="[A-Z a-z]{3,56}" maxlength="50" autofocus required/></td>
    </tr>
    <tr>
