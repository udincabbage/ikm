...
<table class="table table-bordered table-striped">
  ...
  <!-- <form action='?page=<?php echo $formName?>-Data' method="POST">
  <input type='text' value='' name='qcari'>
  <input class="btn btn-primary" type='submit' value='cari'> <a href='?page=<?php echo $formName?>-Data' ><input class="btn btn-primary" type='submit' value='Semua data'></a>
  
 
    <td align="right"><a href="?page=<?php echo $formName?>-Add" target="_self"><img src="images/btn_add_data.png" border="0" /></a></td>
	-->
  ...
  <td > <a class="toggle-link" href="?page=<?php echo $formName?>-Add"><i class="icon-plus"></i> Tambah Data</a>
	...
	<table class="table table-bordered table-striped">
      <tr>
		...
		<th width="150"><strong><?php echo $isian3; ?></strong></th>
		<th width="150"><strong><?php echo $isian4; ?></strong></th>
		<th width="90"><strong><?php echo $isian6; ?></strong></th>
		...
		while ($kolomData = mysqli_fetch_array($myQry)) {
			...
			if($kolomData[$field6]=='1'){$id6='Administrator';}
			elseif($kolomData[$field6]=='3'){$id6='Manajer';}
			else{$id6='Sales';}
		?>
      <tr>
